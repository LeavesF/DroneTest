...
#include "DroneTestSportsCar.h"
#include "DroneTestSportsWheelFront.h"
#include "DroneTestSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADroneTestSportsCar::ADroneTestSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDroneTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDroneTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDroneTestSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDroneTestSportsWheelRear::StaticClass();
